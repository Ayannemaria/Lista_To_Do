            ...
            containerTarefas.insertAdjacentHTML('afterbegin',
                ...
                `<div class="tarefa">
                    ...
                    <div class="tarefa-botaos"> 
                        <button class="completar"><img src="./imgs/completar.png" alt=""></button>
                        <button class="editar"><img src="./imgs/editar.png" alt=""></button>
                        <button class="deletar"><img src="./imgs/deletar.png" alt=""></button>
                    </div>
